...
function EvangelistSection() {
  ...
  const types: Record<string, string[]> = {
    ...
    '活动参与': ['IvorySQL 直播演讲(40)', '主办线下演讲/Workshop(60)', '高校活动分享(40)', '外部活动分享(30)', '组织线下Meetup(30)', '策划和组织直播活动(40)'],
    '社区贡献': ['提交Issue/改进建议(5)', 'Bug提交(5)', '贡献代码/文档PR(25)', '贡献迁移案例/用户故事(40)'],
    '其他': ['宣传社区活动(5)', '转载IvorySQL发版公告(10)', '转发IvorySQL发版公告(5)'],
  };
